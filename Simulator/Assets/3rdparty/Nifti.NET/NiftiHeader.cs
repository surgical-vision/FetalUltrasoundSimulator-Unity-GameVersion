...
namespace Nifti.NET
{
    public class NiftiHeader
    {
        ...
        public const int EXPECTED_SIZE_OF_HDR = 348;
        public int sizeof_hdr = 348;            /*!< MUST be 348           */  /* int sizeof_hdr;      */
        public byte[] data_type = new byte[10]; /*!< ++UNUSED++            */  /* byte data_type[10];  */
        public byte[] db_name = new byte[18];   /*!< ++UNUSED++            */  /* byte db_name[18];    */
        public int extents;                     /*!< ++UNUSED++            */  /* int extents;         */
        public short session_error;             /*!< ++UNUSED++            */  /* short session_error; */
        public byte regular;                    /*!< ++UNUSED++            */  /* byte regular;        */
        public byte dim_info;                   /*!< MRI slice ordering.   */  /* byte hkey_un0;       */

        /*--- was image_dimension substruct ---*/
        public short[] dim = new short[8];      /*!< Data array dimensions.*/  /* short dim[8];        */
        ...
        public float[] pixdim = new float[8];   /*!< Grid spacings.        */  /* float pixdim[8];     */
        ...
        public byte[] descrip = new byte[80];   /*!< any text you like.    */  /* byte descrip[80];    */
        public byte[] aux_file = new byte[24];  /*!< auxiliary filename.   */  /* byte aux_file[24];   */
        ...
        /// <summary>
        /// Check to see if endianess is buggered. If we've read from a big endian file, the size of header will be wrong.
        /// This is a bit of a hacky way to do this, but we can tell after the first read.
        /// By not fixing this field (and only writing the correct value) we can hold endianess for free.
        /// </summary>
        /// <returns></returns>
        public bool SourceIsBigEndian() { return sizeof_hdr == 22806528 || sizeof_hdr == 1543569408; }

        /*---------------------------------------------------------------------------*/
        /* HEADER EXTENSIONS:
           -----------------
           After the end of the 348 byte header (e.g., after the magic field),
           the next 4 bytes are a byte array field named "extension". By default,
        ...
        /// binary nifti_1_header data in a NIFTI-1 header file.If the byte
        ...
        /// </summary>
        public int esize; /*!< size of extension, in bytes (must be multiple of 16) */
        public int ecode; /*!< extension code, one of the NIFTI_ECODE_ values       */
        public byte[] edata; /*!< raw data, with no byte swapping (length is esize-8)  */
...
#region NIFTI1_DATATYPES
        /*--- the original ANALYZE 7.5 type codes ---*/
        public const short DT_NONE = 0;
        public const short DT_UNKNOWN = 0;  /* what it says, dude           */
        public const short DT_BINARY = 1;  /* binary (1 bit/voxel)         */
        public const short DT_UNSIGNED_byte = 2;  /* unsigned byte (8 bits/voxel) */
        public const short DT_SIGNED_SHORT = 4;  /* signed short (16 bits/voxel) */
        public const short DT_SIGNED_INT = 8;  /* signed int (32 bits/voxel)   */
        public const short DT_FLOAT = 16;  /* float (32 bits/voxel)        */
        public const short DT_COMPLEX = 32;  /* complex (64 bits/voxel)      */
        public const short DT_DOUBLE = 64;  /* double (64 bits/voxel)       */
        public const short DT_RGB = 128;  /* RGB triple (24 bits/voxel)   */
        public const short DT_ALL = 255;  /* not very useful (?)          */

        /*----- another set of names for the same ---*/
        public const short DT_UINT8 = 2;
        public const short DT_INT16 = 4;
        public const short DT_INT32 = 8;
        public const short DT_FLOAT32 = 16;
        public const short DT_COMPLEX64 = 32;
        public const short DT_FLOAT64 = 64;
        public const short DT_RGB24 = 128;

        /*------------------- new codes for NIFTI ---*/
        public const short DT_INT8 = 256;    /* signed byte (8 bits)         */
        public const short DT_UINT16 = 512;    /* unsigned short (16 bits)     */
        public const short DT_UINT32 = 768;    /* unsigned int (32 bits)       */
        public const short DT_INT64 = 1024;    /* long long (64 bits)          */
        public const short DT_UINT64 = 1280;    /* unsigned long long (64 bits) */
        public const short DT_FLOAT128 = 1536;    /* long double (128 bits)       */
        public const short DT_COMPLEX128 = 1792;    /* double pair (128 bits)       */
        public const short DT_COMPLEX256 = 2048;    /* long double pair (256 bits)  */
        public const short DT_RGBA32 = 2304;    /* 4 byte RGBA (32 bits/voxel)  */
                                         /* @} */

#endregion
        /*------- aliases for all the above codes ---*/
        ///aliases for the nifti1 datatype codes
#region NIFTI1_DATATYPE_ALIASES

        public const short NIFTI_TYPE_UINT8 = 2;   /*! unsigned byte. */
        public const short NIFTI_TYPE_INT16 = 4;   /*! signed short. */
        public const short NIFTI_TYPE_INT32 = 8;   /*! signed int. */
        public const short NIFTI_TYPE_FLOAT32 = 16;   /*! 32 bit float. */
        public const short NIFTI_TYPE_COMPLEX64 = 32;   /*! 64 bit complex = 2 32 bit floats. */
        public const short NIFTI_TYPE_FLOAT64 = 64;   /*! 64 bit float = double. */
        public const short NIFTI_TYPE_RGB24 = 128;   /*! 3 8 bit bytes. */
        public const short NIFTI_TYPE_INT8 = 256;   /*! signed byte. */
        public const short NIFTI_TYPE_UINT16 = 512;   /*! unsigned short. */
        public const short NIFTI_TYPE_UINT32 = 768;   /*! unsigned int. */
        public const short NIFTI_TYPE_INT64 = 1024;   /*! signed long long. */
        public const short NIFTI_TYPE_UINT64 = 1280;   /*! unsigned long long. */
        public const short NIFTI_TYPE_FLOAT128 = 1536;   /*! 128 bit float = long double. */
        public const short NIFTI_TYPE_COMPLEX128 = 1792;   /*! 128 bit complex = 2 64 bit floats. */
        public const short NIFTI_TYPE_COMPLEX256 = 2048;   /*! 256 bit complex = 2 128 bit floats */
        public const short NIFTI_TYPE_RGBA32 = 2304;   /*! 4 8 bit bytes. */
        #endregion
        ...
        /* INTERPRETATION OF VOXEL DATA:
           ...
           The intent_name field provides space for a 15 byteacter (plus 0 byte)
        ...
        /// </summary>
        public const short NIFTI_INTENT_NONE = 0;
        ...
        /// </summary>
        public const short NIFTI_INTENT_BINOM = 8;
        ...
        /// </summary>
        public const short NIFTI_INTENT_FTEST_NONC = 12;

        /// <summary>
        /// [C2, chap 29] Noncentral chi-squared statistic (2 params):
        ///  p1 = DOF, p2 = noncentrality parameter.
        /// </summary>
        public const short NIFTI_INTENT_CHISQ_NONC = 13;
        ...
        /// </summary>
        public const short NIFTI_INTENT_LOGISTIC = 14;
        ...
        /// </summary>
        public const short NIFTI_INTENT_LAPLACE = 15;

        /// <summary>
        /// [C2, chap 26] Uniform distribution: p1 = lower end, p2 = upper end.
        /// </summary>
        public const short NIFTI_INTENT_UNIFORM = 16;

        /// <summary>
        /// [C2, chap 31] Noncentral t statistic (2 params):
        ///  p1 = DOF, p2 = noncentrality parameter. 
        /// </summary>
        public const short NIFTI_INTENT_TTEST_NONC = 17;
        ...
        /// </summary>
        public const short NIFTI_INTENT_WEIBULL = 18;
        ...
        /// </summary>
        public const short NIFTI_INTENT_CHI = 19;
        ...
        /// </summary>
        public const short NIFTI_INTENT_INVGAUSS = 20;
        ...
        /// </summary>
        public const short NIFTI_INTENT_EXTVAL = 21;

        /// <summary>
        /// Data is a 'p-value' (no params).
        /// </summary>
        public const short NIFTI_INTENT_PVAL = 22;
        ...
        /// </summary>
        public const short NIFTI_INTENT_LOGPVAL = 23;
        ...
        /// </summary>
        public const short NIFTI_INTENT_LOG10PVAL = 24;

        /// <summary>
        /// Smallest intent_code that indicates a statistic.
        /// </summary>
        public const short NIFTI_FIRST_STATCODE = 2;

        /// <summary>
        /// Largest intent_code that indicates a statistic.
        /// </summary>
        public const short NIFTI_LAST_STATCODE = 24;
        ...
        /// </summary>
        public const short NIFTI_INTENT_ESTIMATE = 1001;
        ...
        /// </summary>
        public const short NIFTI_INTENT_GENMATRIX = 1004;
        ...
        ///     - etc.: row-by-row
        /// </summary>
        public const short NIFTI_INTENT_SYMMATRIX = 1005;
        ...
        /// </summary>
        public const short NIFTI_INTENT_DISPVECT = 1006;   /* specifically for displacements */
        public const short NIFTI_INTENT_VECTOR = 1007;   /* for any other type of vector */
        ...
        /// </summary>
        public const short NIFTI_INTENT_POINTSET = 1008;
        ...
        /// </summary>
        public const short NIFTI_INTENT_TRIANGLE = 1009;
        ...
        ///</summary>
        public const short NIFTI_INTENT_QUATERNION = 1010;

        /// <summary>
        /// Dimensionless value - no params - although, as in _ESTIMATE
        /// the name of the parameter may be stored in intent_name.
        /// </summary>
        public const short NIFTI_INTENT_DIMLESS = 1011;
        ...
        /// </summary>
        public const short NIFTI_INTENT_TIME_SERIES = 2001;

        /// <summary>
        /// To signify that the value at each location is a node index, from
        /// a complete surface dataset.
        /// </summary>
        public const short NIFTI_INTENT_NODE_INDEX = 2002;
        ...
        ///   - dim[5] = 3
        /// </summary>
        public const short NIFTI_INTENT_RGB_VECTOR = 2003;
        ...
        ///   - dim[5] = 4
        /// </summary>
        public const short NIFTI_INTENT_RGBA_VECTOR = 2004;

        /// <summary>
        /// To signify that the value at each location is a shape value, such as the curvature.
        /// </summary>
        public const short NIFTI_INTENT_SHAPE = 2005;
...
#region NIFTI1_XFORM_CODES

        /// <summary>
        /// Arbitrary coordinates (Method 1).
        /// </summary>
        public const short NIFTI_XFORM_UNKNOWN = 0;

        /// <summary>
        /// Scanner-based anatomical coordinates
        /// </summary>
        public const short NIFTI_XFORM_SCANNER_ANAT = 1;

        /// <summary>
        /// Coordinates aligned to another file's,
        /// or to anatomical "truth". 
        /// </summary>
        public const short NIFTI_XFORM_ALIGNED_ANAT = 2;
        ...
        public const short NIFTI_XFORM_TALAIRACH = 3;

        /// <summary>
        /// MNI 152 normalized coordinates. 
        /// </summary>
        public const short NIFTI_XFORM_MNI_152 = 4;
        ...
        /// </summary>
        public const short NIFTI_XFORM_TEMPLATE_OTHER = 5;
        ...
        public const short NIFTI_UNITS_UNKNOWN = 0;

        /** Space codes are multiples of 1. **/
        /*! NIFTI code for meters. */
        public const short NIFTI_UNITS_METER = 1;
        /*! NIFTI code for millimeters. */
        public const short NIFTI_UNITS_MM = 2;
        /*! NIFTI code for micrometers. */
        public const short NIFTI_UNITS_MICRON = 3;

        /** Time codes are multiples of 8. **/
        /*! NIFTI code for seconds. */
        public const short NIFTI_UNITS_SEC = 8;
        /*! NIFTI code for milliseconds. */
        public const short NIFTI_UNITS_MSEC = 16;
        /*! NIFTI code for microseconds. */
        public const short NIFTI_UNITS_USEC = 24;

        /*** These units are for spectral data: ***/
        /*! NIFTI code for Hertz. */
        public const short NIFTI_UNITS_HZ = 32;
        /*! NIFTI code for ppm. */
        public const short NIFTI_UNITS_PPM = 40;
        /*! NIFTI code for radians per second. */
        public const short NIFTI_UNITS_RADS = 48;
        #endregion

        public static byte XyztToSpace(byte xyzt) { return (byte)(xyzt & 0x07); }
        public static byte XyztToTime(byte xyzt) { return (byte)(xyzt & 0x38); }

        public static byte SpaceTimeToXyzt(byte ss, byte tt) { return (byte)((ss & 0x07) | (tt & 0x38)); }
        ...
        public static byte DimInfoToFreqDim(byte di) { return (byte)(di & 0x03); }
        public static byte DimInfoToPhaseDim(byte di) { return (byte)((di >> 2) & 0x03); }
        public static byte DimInfoToSliceDim(byte di) { return (byte)((di >> 4) & 0x03); }
        public static byte FpsIntoDimInfo(byte fd, byte pd, byte sd) { return (byte)((fd & 0x03) | ((pd & 0x03) << 2) | ((sd & 0x03) << 4)); }

/// nifti1 slice order codes, describing the acquisition order of the slice
#region NIFTI1_SLICE_ORDER
        public const short NIFTI_SLICE_UNKNOWN  = 0;
        public const short NIFTI_SLICE_SEQ_INC  = 1;
        public const short NIFTI_SLICE_SEQ_DEC  = 2;
        public const short NIFTI_SLICE_ALT_INC  = 3;
        public const short NIFTI_SLICE_ALT_DEC  = 4;
        public const short NIFTI_SLICE_ALT_INC2 = 5;  /* 05 May 2005: RWCox */
        public const short NIFTI_SLICE_ALT_DEC2 = 6;  /* 05 May 2005: RWCox */
        #endregion
        /*---------------------------------------------------------------------------*/
        /* UNUSED FIELDS:
           -------------
           ...
           software to be happy are:
             ...
             regular    dbh.h says this should be the byteacter 'r'
        ...
        /// </summary>
        /// <param name="h"></param>
        /// <returns>Returns NIFTI version number (1..9) if magic is good, 0 if it is not.</returns>
        public static int NiftiVersion(NiftiHeader h)
        {
            return
                (h.magic[0] == 'n' 
                    && h.magic[3] == '\0' 
        ...
        /// </summary>    
        public bool NiftiOneFile(NiftiHeader h) { return (h).magic[1] == '+'; }

        /// <summary>
        /// Check if a nifti_1_header struct needs to be byte swapped.
        /// Returns 1 if it needs to be swapped, 0 if it does not.
        /// </summary>
        public static bool NiftiNeedsSwap(NiftiHeader h) { return ((h).dim[0] < 0 || (h).dim[0] > 7); }

        /// <summary>
        /// Check if a nifti_1_header struct contains a 5th (vector) dimension.
        /// </summary>
        /// <param name="h">Header</param>
        /// <returns>Returns size of 5th dimension if > 1, returns 0 otherwise.</returns>
        public static int Nifti5thDim(NiftiHeader h) { return h.dim[0] > 4 && h.dim[5] > 1 ? (h).dim[5] : 0; }
